  ...
  return (
    <ShellCommandHandlersProvider>
      ...
      >
        ...
        <AppSidebar />
        <SidebarInset className="amb-app-inset amb-shell-inset flex min-h-svh flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col overflow-hidden p-3 md:p-3">{children}</div>
        </SidebarInset>
      </SidebarProvider>
    </ShellCommandHandlersProvider>
  );
