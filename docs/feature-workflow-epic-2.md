...
| 6   | E2-S6 | Контекст tenant/project в запросах                               | Backend  | nest-engineer / Dev       | 📋 Planned     |
...
| Backend      | nest-engineer / Dev       | project-scoped API, RLS, контекст          | E2-S4…E2-S6 | 📋 Queued     |
...
- **MCP:** тред `66ddc5d9-baa6-4040-ae1e-a51d19988e25`. Inbox: Backend **nest-engineer** `d0e135a6-…`, Frontend **react-next-engineer** `72c8cb90-…`, Dev `67600e80-…`, Architect `d6703179-…`, QA `aa052ead-…`.
