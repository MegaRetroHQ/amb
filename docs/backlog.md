...
## Epic 8: Удаление и редактирование сущностей

**Цель:** Пользователь может удалять треды (с каскадом сообщений), агентов и проекты; редактировать название проекта и данные агента.
...
- ✅ Удаление треда доступно в UI, при удалении удаляются все сообщения треда
- ✅ Удаление агента доступно по API и в Dashboard с подтверждением
- ✅ Редактирование названия проекта доступно в Dashboard
