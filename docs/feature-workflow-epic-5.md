...
- **Статус треда:** open  
- E5-S1, E5-S2 Done. E5-S3 in progress | Architect (on_demand) | QA (queued)
...
| 3   | E5-S3 | Docker Compose для локальной разработки | 🚧 In Progress |
| 4   | E5-S4 | Migration guide                  | 📋 Queued      |
...
| Dev       | E5-S3…E5-S5                | E5-S3…E5-S5 | In progress |
